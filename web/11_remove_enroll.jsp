<%-- 
    Document   : 11_remove_enroll
    Created on : Oct 4, 2018, 4:04:05 AM
...
<html>
    ...
    <body>
        <div id="nav1">
         ...
         <%
            try
            {
                ...
                String selQuery =    "select en_id, studentMaster.s_id, studentMaster.name, courseMaster.name "
        ...
        %>
                <form method="post" action="11_remove_enroll_1.jsp">
                    <section>
                              ...
                              <tbody>
                                <tr>
                                 <td><%= rs.getInt("studentMaster.s_id") %></td>
                                  ...
                                  <td>
                                      <input class="selQuery" type="radio" 
                                             name="selectedQuery" 
                                             onclick="show2();"
                                             value="<%= rs.getInt("en_id")%>">
                                  </td>
                                </tr>
                              </tbody>
                            </table>
